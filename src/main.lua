...
--   a .lpplib header. libraries have no overlapping symbols.
                                                                                ...
                                                                                elseif a=="--version" then print("lpp 0.8.0"); os.exit(0)
                                                                                    elseif a=="--conserve-artifacts" then conserve_artifacts=true; i=i+1
                                                                                        elseif a=="--license" then
                                                                                            ...
                                                                                            os.exit(0)
                                                                                            elseif a=="--help" then
                                                                                                print("lpp. it compiles. usually.")
                                                                                                print("")
                                                                                                print("usage: lpp <file.lpp> [flags]")
                                                                                                print("")
                                                                                                print("  -o <n>                 name your binary something cool")
                                                                                                print("  --target <t>           linux or windows (pick one)")
                                                                                                print("  --run / -r             compile it then immediately run it, speedrunner style")
                                                                                                print("  --verbose / -v         print every step so you can watch it suffer")
                                                                                                print("  --conserve-artifacts   keep the .ssa and .s files around (debugging or curiosity)")
                                                                                                print("  --version              print the version and leave")
                                                                                                print("  --license              MIT. yes you can use it. no i won't fix your bugs.")
                                                                                                print("")
                                                                                                print("libraries (slap a linkto \"name\" at the top of your .lpp file):")
                                                                                                local names = {}
                                                                                                for k in pairs(lib_registry) do names[#names+1] = k end
                                                                                                    table.sort(names)
                                                                                                    for _, n in ipairs(names) do print("  "..n) end
                                                                                                        print("")
                                                                                                        print("tip: you can linkto as many libraries as you want.")
                                                                                                        print("tip: if it says 'unknown function', you forgot a linkto.")
                                                                                                        print("tip: if it still doesn't work, read the error message. it's right there.")
                                                                                                        os.exit(0)
                                                                                                        else
