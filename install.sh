...
install -m644 "$LPP_TMP/stdlib.lpplib"     "$LPP_LIB/stdlib.lpplib"
install -m644 "$LPP_TMP/gamelib.c"         "$LPP_LIB/gamelib.c"
install -m644 "$LPP_TMP/gamelib.lpplib"    "$LPP_LIB/gamelib.lpplib"
install -m644 "$LPP_TMP/mathlib.c"         "$LPP_LIB/mathlib.c"
install -m644 "$LPP_TMP/mathlib.lpplib"    "$LPP_LIB/mathlib.lpplib"
install -m644 "$LPP_TMP/threadlib.c"       "$LPP_LIB/threadlib.c"
install -m644 "$LPP_TMP/threadlib.lpplib"  "$LPP_LIB/threadlib.lpplib"
install -m644 "$LPP_TMP/netlib.c"          "$LPP_LIB/netlib.c"
install -m644 "$LPP_TMP/netlib.lpplib"     "$LPP_LIB/netlib.lpplib"
install -m644 "$LPP_TMP/ailib.c"           "$LPP_LIB/ailib.c"
install -m644 "$LPP_TMP/ailib.lpplib"      "$LPP_LIB/ailib.lpplib"
...
echo ":: libs installed to $LPP_LIB"
echo ":: run: lpp --help"
